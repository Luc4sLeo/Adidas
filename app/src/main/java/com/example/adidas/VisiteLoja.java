...
public class VisiteLoja extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.visite_loja);
...
// (filtre por "MapaJS" no Logcat para diagnosticar problemas)
        ...
        webViewMapa.loadUrl("file:///android_asset/mapas.html");
...
// Chama updateLocation() dentro do mapa.html
        ...
        botaoLocalizacao.setOnClickListener(view -> {
            if (ContextCompat.checkSelfPermission(this,
                ...
                webViewMapa.setVisibility(View.VISIBLE);
                solicitarAtualizacaoLocalizacao();
            } else {
        ...
        Button btnEnterStore = findViewById(R.id.btnEnterStore);
        btnEnterStore.setOnClickListener(view -> {
            Intent intent = new Intent(VisiteLoja.this, MainActivity.class);
